...
RIGHT JOIN professionalstable AS pt
...
<!--the status td will show based on logics-->
...
<!--end payment history-->
 ...
 <!--the action buttons-->  
 <td>
<a href="view-professional.php?viewProfessional=<?php echo $row['user_id']; ?>" class="badge bg-success"> <i class="fa fa-eye">View</i> </a></td>  
</td>

<td>
<a href="#?linkProfessional=<?php echo $row['id']; ?>" class="badge bg-primary"> <i class="fa fa-chain">Link</i> </a></td>  
</td>
 
<td>
<a href="#" id="<?php echo $row['user_id']; ?>" class="openPopupBtn badge bg-danger"> <i class="fa fa-trash">Del</i> </a></td>  
</td>
