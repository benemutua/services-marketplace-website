...
//7. this page SHOWS ONLY THE UNREAD MESSAGES
...
<!---------------------------------------------------------------------------------
THE BELOW TABLE SHOWS ALL UNREAD MESSAGES
----------------------------------------------------------------------------------->
...
<?php $getMessages=mysqli_query($link, "SELECT * FROM chatbot WHERE status='delivered' ORDER BY message_id DESC");
...
<td>
<a href="messages-unread.php?seeMessage=<?php echo $row['message_id']; ?>" class="readTheMessage badge bg-primary"><i class="fa fa-eye">Read</i> </a></td>  
</td>
<?php else: ?>
<td>
<a href="messages-unread.php?seeMessage=<?php echo $row['message_id']; ?>" class="readTheMessage badge bg-success"><i class="fa fa-eye">Read/ply</i> </a></td>  
</td>
<?php endif; ?>
