...
LEFT JOIN paymentstable AS pyt ON pt.user=pyt.user
...
<div class="input-group">
    ...
    &nbsp;
    <button type="submit" name="bulkDeletePayments" class="btn btn-danger fa fa-trash" formaction="dboperations.php" onclick="return confirm('The selected payments will be deleted permanently. Proceed?')">Bulk</button>  
  </div>
</div>
...
<!--if there are users, display them-->
    ...
    <tr>
      ...
      <td><input type="checkbox" name="checkbox[]" value="<?php echo $row['payment_id']; ?>"></td>
...
<td>
<a href="dboperations.php?delPayments=<?php echo $row['payment_id']; ?>" class="badge bg-danger" onclick="return confirm('The row payment will be deleted permanently and cant be recovered. Proceed?')"> <i class="fa fa-trash">Del</i></a></td>  
</td>

<td>
<a href="dboperations.php?printUserStatements=<?php echo $row['payment_id']; ?>" class="badge bg-secondary"> <i class="fa fa-print">Print</i></a></td>  
</td>
