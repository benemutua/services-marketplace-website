...
WHERE payment_message='success' AND account='boosting' AND MONTH(add_date) = MONTH(CURRENT_DATE())
...
WHERE 
username LIKE '%$searchValue%' AND account='boosting'
OR email LIKE '%$searchValue%' AND account='boosting'
OR first_name LIKE '%$searchValue%' AND account='boosting'
OR other_names LIKE '%$searchValue%' AND account='boosting'
OR mobile_number LIKE '%$searchValue%' AND account='boosting'
